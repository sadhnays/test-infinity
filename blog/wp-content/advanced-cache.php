...
// WP-Optimize advanced-cache.php (written by version: 4.6.1) (homeurl: https://infinitysofthub.com/blog/) (abspath: /home/u469024108/domains/infinitysofthub.com/public_html/blog/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/home/u469024108/domains/infinitysofthub.com/public_html/blog/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://infinitysofthub.com/blog/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/u469024108/domains/infinitysofthub.com/public_html/blog/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-infinitysofthub.com.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-infinitysofthub.com.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-infinitysofthub.com.php');
}
