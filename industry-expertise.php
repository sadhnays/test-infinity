            ...
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        ...
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Virtual Lab Environments</strong> - Browser-based coding labs and sandboxes</span></li>
                    ...
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                ...
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Training Portals</strong> - Centralized learning hubs</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Skill Assessments</strong> - Automated testing and certification</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Gamified Learning</strong> - Engaging training experiences</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Progress Analytics</strong> - Track and measure learning outcomes</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Patient Portals</strong> - Secure access to medical records</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Telemedicine Apps</strong> - Video consultations and monitoring</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>AI Diagnostics</strong> - Machine learning for medical imaging</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Practice Management</strong> - Scheduling and billing systems</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
                <div class="anim-fade-left" data-aos="fade-left">
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                ...
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Smart Factory Apps</strong> - IoT-enabled monitoring</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Predictive Maintenance</strong> - AI-powered equipment monitoring</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Supply Chain Systems</strong> - End-to-end visibility</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Quality Control</strong> - Automated inspection and reporting</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Digital Banking</strong> - Web and mobile banking platforms</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Fraud Detection</strong> - AI-powered security systems</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Wealth Management</strong> - Portfolio tracking and analytics</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Compliance Tools</strong> - Automated reporting and auditing</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
                <div class="anim-fade-left" data-aos="fade-left">
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                ...
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>E-commerce Platforms</strong> - Custom online stores</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>POS Systems</strong> - Integrated in-store and online sales</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>AI Recommendations</strong> - Personalized product suggestions</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Inventory Management</strong> - Real-time stock tracking</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="content-grid-2 mt-3rem" style="align-items:center;">
                <div class="anim-fade-right" data-aos="fade-right">
                    ...
                    <ul class="check-list">
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Citizen Portals</strong> - Online government services</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Grant Management</strong> - NGO funding and project tracking</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Data Analytics</strong> - Public policy and program insights</span></li>
                        <li><span class="li-icon">✓</span><span class="li-text"><strong>Transparency Tools</strong> - Open data and reporting systems</span></li>
                    </ul>
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary mt-2rem">Get a Quote</a>
                </div>
                <div class="anim-fade-left" data-aos="fade-left">
