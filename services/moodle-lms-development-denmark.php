<?php
// services/moodle-lms-development-denmark.php
$pageTitle = "Custom Moodle™ LMS Developer Denmark | Infinity SoftHub";
$pageDescription = "Custom services for Moodle™ LMS in Denmark. We build custom Moodle™ plugins, themes, and secure GDPR-compliant cloud portals.";
    ...
    <div class="container">
        <div class="anim-fade-up">
            <div class="badge badge-primary" style="margin-bottom:1.5rem; display:inline-flex;">
                <i class="fa fa-map-marker-alt"></i> Denmark E-Learning
            </div>
            <h1>Custom Moodle™ <span class="gradient-text">Developer Denmark</span></h1>
            <p>Bespoke Moodle™ and LearnDash development services tailored for Danish universities, academies, and corporate training ecosystems. 100% GDPR-compliant, secure AWS Europe hosting.</p>
        </div>
    </div>
</section>

<!-- Denmark Service Description -->
    ...
    <div class="container">
        <div class="content-grid-2 anim-fade-right">
            <div>
                ...
                <p style="margin-bottom:1.5rem;">We help Danish educational institutions and corporations build, customize, and maintain secure LMS architectures. Our full-stack development workflow supports custom Moodle™ plugins and theme designs matching EU web safety standards.</p>
                <ul class="check-list">
                    ...
                    <li><strong>AWS Europe Data Hosting</strong> - Hosting deployed in AWS Stockholm or Frankfurt for minimum latency in Denmark.</li>
                ...
                <div style="margin-top:2rem;">
                    <a href="<?php echo base_url('contact.php'); ?>" class="btn btn-primary">
                        <i class="fa fa-calendar-check"></i> Book Denmark Consultation
                    </a>
                </div>
            </div>
            <div class="anim-fade-left">
                <div style="background: linear-gradient(135deg, #0b1528, #1e2e4a); border-radius: var(--radius-xl); padding: 2.5rem; border: 1px solid #2563eb; height: 100%; display: flex; flex-direction: column; justify-content: center;">
                    <h3 style="color: #60a5fa; margin-bottom: 1rem;"><i class="fa fa-graduation-cap"></i> Danish E-Learning</h3>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <span style="background: #1e2e4a; color: #60a5fa; padding: 0.4rem 0.8rem; border-radius: 6px; font-size: 0.8rem; font-weight: 600;">Moodle™ DK</span>
...
<section class="content-section bg-alt">
    <div class="container">
        <div class="section-header anim-fade-up">
            <div class="section-tag">Danish Standards</div>
        ...
        <div class="grid grid-3" style="margin-top:3rem;">
            ...
            <div class="feature-card anim-fade-up" style="animation-delay: 0.1s;">
                ...
                <p>Deploy your courses in AWS Europe regions for maximum compliance and extremely fast page loads in Denmark.</p>
            </div>
            <div class="feature-card anim-fade-up" style="animation-delay: 0.2s;">
                ...
                <p>Configure Moodle™ translations and localized layouts to support Danish language smoothly.</p>
            </div>
        </div>
    </div>
</section>
